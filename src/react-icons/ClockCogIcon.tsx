...
export const ClockCogIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg   viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg" stroke={props.color || 'currentColor'} fill={props.fill || 'none'} width={props.width || 15} height={props.height || 15} {...props}>
<g clipPath="url(#clip0_802_78582)">
<path d="M21 12C21 10.2201 20.4722 8.48008 19.4834 7.00008C18.4945 5.52008 17.089 4.36653 15.4446 3.68528C13.8002 3.00403 11.9907 2.82569 10.2449 3.17279C8.49915 3.5199 6.8955 4.37686 5.63675 5.63534C4.378 6.89381 3.52067 8.49727 3.17318 10.243C2.82569 11.9887 3.00363 13.7982 3.68451 15.4428C4.3654 17.0873 5.51864 18.4931 6.99842 19.4823C8.4782 20.4714 10.2181 20.9996 11.998 21"  strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
