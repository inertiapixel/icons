...
export const AdjustmentsPinIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg   viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg" stroke={props.color || 'currentColor'} fill={props.fill || 'none'} width={props.width || 15} height={props.height || 15} {...props}>
<g clipPath="url(#clip0_802_86284)">
...
<path d="M13.0695 14.31C12.8075 14.1441 12.5104 14.0415 12.2018 14.0102C11.8933 13.9789 11.5817 14.0198 11.2916 14.1296C11.0016 14.2395 10.7411 14.4153 10.5307 14.6431C10.3203 14.871 10.1657 15.1447 10.0793 15.4425C9.99282 15.7404 9.97682 16.0542 10.0325 16.3593C10.0883 16.6644 10.2142 16.9524 10.4003 17.2005C10.5865 17.4485 10.8278 17.6499 11.1052 17.7887C11.3825 17.9274 11.6884 17.9998 11.9985 18"  strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M18 9V11.5"  strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
