...
export const CopyrightOffIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg   viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={props.color || 'currentColor'} width={props.width || 15} height={props.height || 15} {...props}>
<g clipPath="url(#clip0_802_77798)">
<path d="M14.0011 9.75116C13.7873 9.56303 13.5479 9.40614 13.2901 9.28516M9.88012 9.88116C9.32404 10.4354 9.00801 11.186 9.00015 11.9711C8.99229 12.7561 9.29324 13.5129 9.83812 14.0782C10.3765 14.637 11.1096 14.9669 11.8849 14.9991C12.6603 15.0313 13.4182 14.7634 14.0011 14.2512"  strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
