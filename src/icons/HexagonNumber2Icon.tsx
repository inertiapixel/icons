...
const SvgHexagonNumber2Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#hexagon-number-2-icon_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="hexagon-number-2-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgHexagonNumber2Icon;
