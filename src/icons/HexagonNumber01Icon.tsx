...
const SvgHexagonNumber01Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#hexagon-number-0-1-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="hexagon-number-0-1-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgHexagonNumber01Icon;
