...
const SvgClockHour8Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#clock-hour-8-icon_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="clock-hour-8-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgClockHour8Icon;
