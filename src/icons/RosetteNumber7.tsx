...
const SvgRosetteNumber7 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#rosette-number-7_svg__a)"
    >
      <path d="M10 8h4l-2 8" />
    ...
    <defs>
      <clipPath id="rosette-number-7_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgRosetteNumber7;
