...
const SvgAlignBoxLeftTop = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#align-box-left-top_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="align-box-left-top_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgAlignBoxLeftTop;
