...
const SvgView360NumberIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#view-360-number-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="view-360-number-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgView360NumberIcon;
