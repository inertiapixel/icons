...
const SvgLayoutBottombarCollapse = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#layout-bottombar-collapse_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="layout-bottombar-collapse_svg__a">
