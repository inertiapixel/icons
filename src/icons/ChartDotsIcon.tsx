...
const SvgChartDotsIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#chart-dots-icon_svg__a)">
    ...
    <defs>
      <clipPath id="chart-dots-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgChartDotsIcon;
