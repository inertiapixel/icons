...
const SvgTimeDuration15Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#time-duration-15-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="time-duration-15-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgTimeDuration15Icon;
