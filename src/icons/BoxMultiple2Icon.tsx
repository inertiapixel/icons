...
const SvgBoxMultiple2Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#box-multiple-2-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="box-multiple-2-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBoxMultiple2Icon;
