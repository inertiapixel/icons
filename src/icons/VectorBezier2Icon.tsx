...
const SvgVectorBezier2Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#vector-bezier-2-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="vector-bezier-2-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgVectorBezier2Icon;
