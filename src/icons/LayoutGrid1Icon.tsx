...
const SvgLayoutGrid1Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#layout-grid-1-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="layout-grid-1-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgLayoutGrid1Icon;
