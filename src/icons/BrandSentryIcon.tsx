...
const SvgBrandSentryIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#brand-sentry-icon_svg__a)">
      <path
        stroke="currentColor"
        strokeLinecap="round"
    ...
    <defs>
      <clipPath id="brand-sentry-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBrandSentryIcon;
