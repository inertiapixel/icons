...
const SvgPentagonNumber9 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#pentagon-number-9_svg__a)"
    >
    ...
    <defs>
      <clipPath id="pentagon-number-9_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgPentagonNumber9;
