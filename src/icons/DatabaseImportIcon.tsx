...
const SvgDatabaseImportIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#database-import-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="database-import-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgDatabaseImportIcon;
