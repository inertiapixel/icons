...
export const MessageCircleHeartIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg width={props.width || 15} height={props.height || 15} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.25" {...props}>
<g clipPath="url(#clip0_802_68729)">
<path d="M10.59 19.8817C9.58684 19.7401 8.61184 19.4432 7.7 19.0017L3 20.0017L4.3 16.1017C1.976 12.6647 2.874 8.22968 6.4 5.72768C9.926 3.22668 14.99 3.43168 18.245 6.20768C19.81 7.54268 20.724 9.27268 20.955 11.0687" stroke="black" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
