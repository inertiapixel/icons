...
const SvgBrandEvernoteIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#brand-evernote-icon_svg__a)"
    >
      <path d="M4 8h5V3" />
    ...
    <defs>
      <clipPath id="brand-evernote-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBrandEvernoteIcon;
