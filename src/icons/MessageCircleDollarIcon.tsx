...
export const MessageCircleDollarIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg   viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={props.color || 'currentColor'} width={props.width || 15} height={props.height || 15} {...props}>
<g clipPath="url(#clip0_802_68743)">
<path d="M13.16 19.9157C11.2902 20.1342 9.39673 19.8172 7.7 19.0017L3 20.0017L4.3 16.1017C1.976 12.6647 2.874 8.22968 6.4 5.72768C9.926 3.22668 14.99 3.43168 18.245 6.20768C19.629 7.38868 20.505 8.87968 20.848 10.4507"  strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
