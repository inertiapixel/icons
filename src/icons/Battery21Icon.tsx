...
const SvgBattery21Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#battery-2-1-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="battery-2-1-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBattery21Icon;
