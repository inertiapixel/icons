...
const SvgSquareRoundedLetterW = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#square-rounded-letter-w_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="square-rounded-letter-w_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgSquareRoundedLetterW;
