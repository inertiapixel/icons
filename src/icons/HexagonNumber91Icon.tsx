...
const SvgHexagonNumber91Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#hexagon-number-9-1-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="hexagon-number-9-1-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgHexagonNumber91Icon;
