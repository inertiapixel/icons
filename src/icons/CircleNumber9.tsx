...
const SvgCircleNumber9 = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#circle-number-9_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="circle-number-9_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgCircleNumber9;
