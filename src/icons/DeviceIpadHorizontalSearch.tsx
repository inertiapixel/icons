...
const SvgDeviceIpadHorizontalSearch = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#device-ipad-horizontal-search_svg__a)"
    >
    ...
    <defs>
      <clipPath id="device-ipad-horizontal-search_svg__a">
