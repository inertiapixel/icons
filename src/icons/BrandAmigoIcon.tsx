...
const SvgBrandAmigoIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#brand-amigo-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="brand-amigo-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBrandAmigoIcon;
