...
const SvgEaseInOutControlPoints = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#ease-in-out-control-points_svg__a)"
    >
    ...
    <defs>
      <clipPath id="ease-in-out-control-points_svg__a">
