...
const SvgWorldQuestionIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#world-question-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="world-question-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgWorldQuestionIcon;
