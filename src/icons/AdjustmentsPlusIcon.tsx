...
export const AdjustmentsPlusIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg   viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={props.color || 'currentColor'} width={props.width || 15} height={props.height || 15} {...props}>
<g clipPath="url(#clip0_802_86271)">
...
<path d="M13.9579 15.592C13.8808 15.2219 13.7004 14.8812 13.4375 14.6094C13.1746 14.3377 12.8401 14.146 12.4727 14.0567C12.1054 13.9673 11.7202 13.9839 11.3619 14.1045C11.0036 14.2252 10.6868 14.4449 10.4482 14.7382C10.2097 15.0316 10.0592 15.3865 10.0142 15.7619C9.96922 16.1373 10.0315 16.5178 10.194 16.8592C10.3564 17.2006 10.6122 17.489 10.9319 17.6909C11.2515 17.8928 11.6219 18 11.9999 18"  strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
