...
const SvgPlayerEjectIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#player-eject-icon_svg__a)">
    ...
    <defs>
      <clipPath id="player-eject-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgPlayerEjectIcon;
