...
const SvgSquareRoundedChevronRight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#square-rounded-chevron-right_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="square-rounded-chevron-right_svg__a">
