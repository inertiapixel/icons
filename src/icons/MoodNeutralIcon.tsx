...
const SvgMoodNeutralIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#mood-neutral-icon_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="mood-neutral-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgMoodNeutralIcon;
