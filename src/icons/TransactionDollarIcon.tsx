...
const SvgTransactionDollarIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#transaction-dollar-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="transaction-dollar-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgTransactionDollarIcon;
