...
export const BellPlus1Icon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg width={props.width || 15} height={props.height || 15} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.25" {...props}>
<g clipPath="url(#clip0_802_83857)">
...
<path d="M9 17V18C8.9999 18.4372 9.09536 18.8691 9.27969 19.2656C9.46402 19.662 9.73277 20.0133 10.0671 20.295C10.4015 20.5767 10.7934 20.7819 11.2153 20.8962C11.6373 21.0106 12.0792 21.0313 12.51 20.957" stroke="black" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
