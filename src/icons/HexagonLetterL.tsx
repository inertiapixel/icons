...
const SvgHexagonLetterL = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#hexagon-letter-l_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="hexagon-letter-l_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgHexagonLetterL;
