...
export const EyeExclamationIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg width={props.width || 15} height={props.height || 15} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.25" {...props}>
<g clipPath="url(#clip0_802_74618)">
...
<path d="M15.03 17.478C14.0585 17.8285 13.0328 18.0052 12 18C8.4 18 5.4 16 3 12C5.4 8 8.4 6 12 6C15.6 6 18.6 8 21 12C20.9157 12.1407 20.8297 12.2804 20.742 12.419" stroke="black" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
