...
const SvgCopyCheck1Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#copy-check-1-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="copy-check-1-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgCopyCheck1Icon;
