...
const SvgView360Off = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#view-360-off_svg__a)"
    >
      ...
      <path d="M5.65 5.624a9 9 0 1 0 12.71 12.745m1.683-2.328A9 9 0 0 0 7.95 3.96" />
    ...
    <defs>
      <clipPath id="view-360-off_svg__a">
