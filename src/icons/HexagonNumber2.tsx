...
const SvgHexagonNumber2 = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#hexagon-number-2_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="hexagon-number-2_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgHexagonNumber2;
