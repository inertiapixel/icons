...
const SvgBucketOffIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#bucket-off-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="bucket-off-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBucketOffIcon;
