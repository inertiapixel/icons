...
const SvgBrandRumbleIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#brand-rumble-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="brand-rumble-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBrandRumbleIcon;
