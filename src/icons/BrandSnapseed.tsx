...
const SvgBrandSnapseed = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#brand-snapseed_svg__a)"
    >
      ...
      <path d="m8 20 12.09-.012c.503 0 .91-.434.91-.969v-6.063c0-.535-.407-.968-.91-.968h-7.382" />
    </g>
    <defs>
      <clipPath id="brand-snapseed_svg__a">
