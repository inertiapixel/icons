...
const SvgDevicesQuestion = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#devices-question_svg__a)"
    >
    ...
    <defs>
      <clipPath id="devices-question_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgDevicesQuestion;
