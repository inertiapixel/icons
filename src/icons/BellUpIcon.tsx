...
export const BellUpIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg width={props.width || 15} height={props.height || 15} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.25" {...props}>
<g clipPath="url(#clip0_802_83811)">
...
<path d="M9 17V18C8.99996 18.4354 9.09471 18.8657 9.27768 19.2608C9.46065 19.656 9.72744 20.0065 10.0595 20.2882C10.3916 20.5699 10.781 20.7759 11.2008 20.8919C11.6205 21.0079 12.0604 21.0311 12.49 20.96" stroke="black" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
