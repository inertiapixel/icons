...
const SvgLayoutSidebarRightExpand = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#layout-sidebar-right-expand_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="layout-sidebar-right-expand_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgLayoutSidebarRightExpand;
