...
export const EyePauseIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg width={props.width || 15} height={props.height || 15} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.25" {...props}>
<g clipPath="url(#clip0_802_74597)">
...
<path d="M13.022 17.945C12.6826 17.9821 12.3414 18.0004 12 18C8.4 18 5.4 16 3 12C5.4 8 8.4 6 12 6C15.6 6 18.6 8 21 12C20.805 12.325 20.606 12.636 20.404 12.935" stroke="black" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
