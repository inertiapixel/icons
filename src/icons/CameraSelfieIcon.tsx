...
const SvgCameraSelfieIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#camera-selfie-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="camera-selfie-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgCameraSelfieIcon;
