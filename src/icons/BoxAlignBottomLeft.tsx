...
const SvgBoxAlignBottomLeft = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#box-align-bottom-left_svg__a)">
    ...
    <defs>
      <clipPath id="box-align-bottom-left_svg__a">
