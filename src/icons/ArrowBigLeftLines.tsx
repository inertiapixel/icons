...
const SvgArrowBigLeftLines = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#arrow-big-left-lines_svg__a)">
    ...
    <defs>
      <clipPath id="arrow-big-left-lines_svg__a">
