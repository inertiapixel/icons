...
const SvgRosetteNumber5 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#rosette-number-5_svg__a)"
    >
    ...
    <defs>
      <clipPath id="rosette-number-5_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgRosetteNumber5;
