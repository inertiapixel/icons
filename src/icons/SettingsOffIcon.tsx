...
const SvgSettingsOffIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#settings-off-icon_svg__a)"
    >
      ...
      <path d="M9.887 9.868a3 3 0 1 0 4.226 4.26m.592-3.424a3 3 0 0 0-1.419-1.415M3 3l18 18" />
    </g>
    <defs>
      <clipPath id="settings-off-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgSettingsOffIcon;
