...
const SvgTransformPointBottomRight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#transform-point-bottom-right_svg__a)"
    >
    ...
    <defs>
      <clipPath id="transform-point-bottom-right_svg__a">
