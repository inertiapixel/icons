...
const SvgAirConditioningDisabled = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#air-conditioning-disabled_svg__a)"
    >
    ...
    <defs>
      <clipPath id="air-conditioning-disabled_svg__a">
