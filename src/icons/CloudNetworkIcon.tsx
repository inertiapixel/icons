...
const SvgCloudNetworkIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#cloud-network-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="cloud-network-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgCloudNetworkIcon;
