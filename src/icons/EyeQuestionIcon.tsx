...
export const EyeQuestionIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg width={props.width || 15} height={props.height || 15} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.25" {...props}>
<g clipPath="url(#clip0_802_74579)">
...
<path d="M14.071 17.764C13.3922 17.9227 12.6971 18.0019 12 18C8.4 18 5.4 16 3 12C5.4 8 8.4 6 12 6C15.346 6 18.173 7.727 20.482 11.182" stroke="black" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
