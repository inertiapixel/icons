...
const SvgBarrierBlockIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#barrier-block-icon_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="barrier-block-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBarrierBlockIcon;
