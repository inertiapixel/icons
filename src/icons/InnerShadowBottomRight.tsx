...
const SvgInnerShadowBottomRight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#inner-shadow-bottom-right_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="inner-shadow-bottom-right_svg__a">
