...
const SvgCircleLetterY = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#circle-letter-y_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="circle-letter-y_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgCircleLetterY;
