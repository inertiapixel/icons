...
const SvgRouteScanIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#route-scan-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="route-scan-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgRouteScanIcon;
