...
export const MessageCirclePinIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg   viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={props.color || 'currentColor'} width={props.width || 15} height={props.height || 15} {...props}>
<g clipPath="url(#clip0_802_68711)">
<path d="M12.337 19.9757C10.7352 20.0315 9.14393 19.6972 7.7 19.0017L3 20.0017L4.3 16.1017C1.976 12.6647 2.874 8.22968 6.4 5.72768C9.926 3.22668 14.99 3.43168 18.245 6.20768C19.875 7.59768 20.799 9.41768 20.981 11.2927"  strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
