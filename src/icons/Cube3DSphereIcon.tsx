...
const SvgCube3DSphereIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#cube-3d-sphere-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="cube-3d-sphere-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgCube3DSphereIcon;
