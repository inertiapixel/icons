...
const SvgDeviceIpadHorizontalQuestion = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#device-ipad-horizontal-question_svg__a)"
    >
    ...
    <defs>
      <clipPath id="device-ipad-horizontal-question_svg__a">
