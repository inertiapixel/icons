...
const SvgBrandBlenderIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#brand-blender-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="brand-blender-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBrandBlenderIcon;
