...
export const DropletDollarIcon = (
  props: React.SVGProps<SVGSVGElement> & { width?: number; height?: number; color?: string }
) => (
  <svg   viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={props.color || 'currentColor'} width={props.width || 15} height={props.height || 15} {...props}>
<g clipPath="url(#clip0_802_75075)">
<path d="M17.6682 10.2917L13.1752 3.61873C12.7542 2.99373 11.8872 2.81573 11.2382 3.22173C11.0753 3.32396 10.9356 3.4592 10.8282 3.61873L5.9352 10.8787C4.2402 13.7167 4.9002 17.3197 7.5022 19.4247C8.26618 20.0381 9.1477 20.4886 10.0924 20.7483C11.0371 21.008 12.025 21.0714 12.9952 20.9347"  strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
