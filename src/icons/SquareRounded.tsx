...
const SvgSquareRounded = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#square-rounded_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="square-rounded_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgSquareRounded;
