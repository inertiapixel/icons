...
const SvgHexagonalPrismPlus = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#hexagonal-prism-plus_svg__a)"
    >
      <path d="M20.793 6.996 17.018 9.64c-.337.235-.737.36-1.147.361H8.13c-.41 0-.81-.126-1.146-.362L3.21 6.998M8 10v11M16 10v3.5" />
    ...
    <defs>
      <clipPath id="hexagonal-prism-plus_svg__a">
