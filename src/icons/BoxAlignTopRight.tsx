...
const SvgBoxAlignTopRight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#box-align-top-right_svg__a)">
    ...
    <defs>
      <clipPath id="box-align-top-right_svg__a">
