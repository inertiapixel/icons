...
const SvgHexagonNumber51 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#hexagon-number-5-1_svg__a)"
    >
    ...
    <defs>
      <clipPath id="hexagon-number-5-1_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgHexagonNumber51;
