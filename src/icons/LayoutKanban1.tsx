...
const SvgLayoutKanban1 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#layout-kanban-1_svg__a)"
    >
    ...
    <defs>
      <clipPath id="layout-kanban-1_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgLayoutKanban1;
