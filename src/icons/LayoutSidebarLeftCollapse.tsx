...
const SvgLayoutSidebarLeftCollapse = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#layout-sidebar-left-collapse_svg__a)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="layout-sidebar-left-collapse_svg__a">
