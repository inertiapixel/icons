...
const SvgChartDots2Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#chart-dots-2-icon_svg__a)"
    >
      <path d="M3 3v18h18" />
    ...
    <defs>
      <clipPath id="chart-dots-2-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgChartDots2Icon;
