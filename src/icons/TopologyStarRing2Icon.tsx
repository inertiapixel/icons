...
const SvgTopologyStarRing2Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#topology-star-ring-2-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="topology-star-ring-2-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgTopologyStarRing2Icon;
