...
const SvgBrandElasticIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#brand-elastic-icon_svg__a)"
    >
      ...
      <path d="m9.5 5-1 4 1 2 5 2 4-4M18.5 16l-3-.5-1-2.5M14.5 19l1-3.5M5.418 15l4.083-4" />
    </g>
    <defs>
      <clipPath id="brand-elastic-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBrandElasticIcon;
