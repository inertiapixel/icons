...
const SvgRosetteNumber1Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#rosette-number-1-icon_svg__a)"
    >
      <path d="m10 10 2-2v8" />
    ...
    <defs>
      <clipPath id="rosette-number-1-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgRosetteNumber1Icon;
