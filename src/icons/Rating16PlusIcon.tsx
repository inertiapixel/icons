...
const SvgRating16PlusIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#rating-16-plus-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="rating-16-plus-icon_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgRating16PlusIcon;
